...
<body>
        ...
        <?php if ($result_caja) { ?>
            <div style="flex-wrap: wrap;">
                ...
                <div style="width: 59%; float: left;">
                    <br>
                    <input type="text" name="busquedaProdCompra" id="busquedaProdCompra" placeholder="Buscar por código o descripción">
                    <br>
                    <div class="containerTable" id="dataProdCompra"></div>
                    <div class="paginador" id="paginadorProdCompra"></div>
                </div>

                <div style="width: 39%; float: right; margin: 5pt;">
                    <table>
                        <tr>
                            <td>
                                ...
                                <input type="text" name="dir_proveedor" id="dir_proveedor" disabled placeholder="Dirección">
                                <input type="text" name="con_proveedor" id="con_proveedor" placeholder="Contacto" disabled>
                            </td>
                            <td>
                                <input type="text" name="con_proveedor" id="con_proveedor" placeholder="Contacto" disabled>
                                ...
                                <input type="text" name="" value="Usuario: <?php echo $_SESSION['nombre']; ?>" disabled>
                            </td>
                        </tr>
                    </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#nom_proveedor').autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    $('#con_proveedor').val(ui.item.contacto);
                }
            });
        });
        ...
        function comprar() {
            ...
            // Aquí podrías hacer una llamada AJAX para guardar la compra en la base de datos
        }

        function anularCompra() {
            // Lógica para anular la compra aquí
            alert('Compra anulada!');
            // Aquí podrías hacer una llamada AJAX para anular la compra en la base de datos
        }
    </script>
