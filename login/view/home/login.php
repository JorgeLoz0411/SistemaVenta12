...
<div class="fondo-login">
    ...
    <form action="/sistemaventa/login/home/verificar.php" method="POST" class="col-3 login" autocomplete="off">
        <div class="mb-0">
    ...
    <div class="login col-3 mt-0">
        Nuevo en CarCom? <a href="/sistemaventa/login/home/signup.php" style="text-decoration: none">Crear una cuenta</a>
    </div>
</div>
<style>
    .icon .car-icon {
